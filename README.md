...
* Install [stolon](https://github.com/kvaps/stolon-chart) chart:
  ...
  curl -LO https://github.com/kvaps/kube-linstor/raw/v1.12.0/examples/linstor-db.yaml
...
* Install kube-linstor chart:
  ...
  ```bash
  # download example values
  curl -LO https://github.com/kvaps/kube-linstor/raw/v1.12.0/examples/linstor.yaml

  # install release
  helm install linstor kvaps/linstor --version 1.12.0 \
    --namespace linstor \
    -f linstor.yaml
  ```
